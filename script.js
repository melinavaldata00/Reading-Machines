...
const humanLines = [
    ...
    "computational systems — what happens to text",
    "once it becomes subject to machine reading,",
    "processing, and recognition, and what this",
    "reveals about reading and writing as human",
    "processes.",
    "",
    "This site holds four tools built on that",
    "investigation:",
    "",
    "OCR Skeleton — how a machine first guesses",
    "where writing is, before guessing what it says.",
    "",
    "Blind Contour — keeps only what reads as",
    "writing, discards the rest as noise, and",
    "returns its bare outline.",
    "",
    "Anti Type — the exact point where a letter,",
    "still visible to a human eye, stops being",
    "legible to a machine.",
    "",
    "Reading Loop — a machine reading its own",
    "previous reading, and what that repetition does",
    "to a text.",
    "",
